                            ...
                            <div class="directory-text-wrap">
                                ...
                                <div class="directory-table table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><img src="{{ asset('frontend/assets/images/testimonial/testi-1.png') }}" alt="table">Angelina Jolie
                                                    Voight
                                                </td>
                                                <td>Computer</td>
                                                <td>2014</td>
                                            ...
                                            <tr>
                                                <td><img src="{{ asset('frontend/assets/images/testimonial/testi-2.png') }}" alt="table">Angelina Jolie
                                                    Voight
                                                </td>
                                                <td>Computer</td>
                                                <td>2014</td>
                                            ...
                                            <tr>
                                                <td><img src="{{ asset('frontend/assets/images/testimonial/testi-3.png') }}" alt="table">Angelina Jolie
                                                    Voight
                                                </td>
                                                <td>Computer</td>
                                                <td>2014</td>
