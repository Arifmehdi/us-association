                ...
                <div class="row">
                    <div class="col-lg-8 m-auto text-center">
                        <div class="page-title-content">
                            <h1 class="h2">Vendor Registration</h1>
                            <p>
                                        ...
                                        <div class="row justify-content-between">
                                            ...
                                            <div class="col-lg-7 col-md-6 ml-auto">
                                                <div class="register-form-wrap">
                                                    <h3>Vendor Registratrion Form</h3>
                                                        ...
                                                        <form action="#">
                                                            ...
                                                            <div class="col-12 col-sm-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="checkbox" class="custom-control-input" id="customCheck1"> Yes <br>
                                                                        <input type="checkbox" class="custom-control-input" id="customCheck1"> No <br>
                                                                    </div>
                                                                </div>
                                                            </div>
