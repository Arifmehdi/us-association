...
jQuery(document).ready(function (o) {
              ...
              o("header .has-submenu i").on("click", function () {
                  o(this).hasClass("animation") ||
                      ...
                      o(this)
                          ...
                          .prev(".sub-menu")
                          .slideUp(250),
                      o(this).hasClass("hide-drop")
                          ? (o(this).closest(".sub-menu").length ||
                                o(".has-submenu i")
                                    .addClass("hide-drop")
                                    .next(".sub-menu")
                                    .hide(250),
                          ...
                          : o(this)
                                ...
                                .hide(250)),
                      setTimeout(function () {
                          o("header .codeboxr-main-menu i").removeClass(
                              "animation"
                          );
                      }, 250);
              }))
    ...
    o(
        '.codeboxr-main-menu li a[href="' +
            (e = "" == e ? "index.html" : e) +
            '"]'
    )
        .parent()
        .addClass("current-menu-item"),
        o(".burger-menu").on("click", function () {
            o(".canvas-menu-wrapper").toggleClass("open-menu"),
                o("body").toggleClass("no-scroll");
        }),
        ...
        o(window).on("scroll", function () {
            o(window).scrollTop() < 150
                ? o(".header-fixed").removeClass("showed")
                : o(".header-fixed").addClass("showed");
        });
    e = o(".slider-active-wrap");
    e.on("initialized.owl.carousel", function (e) {
        ...
        e.owlCarousel({ callbacks: !0 }),
        o(".social-networks-icon").addClass("social-networks-icon-display"),
        ...
        o(".funfact-count").counterUp({ delay: 50, time: 1e3 }),
        o(".gallery-gird").isotope(),
        o(".gallery-menu span").on("click", function () {
            o(".gallery-menu span").removeClass("active"),
                o(this).addClass("active");
            var e = o(this).attr("data-filter");
            return o(".gallery-gird").isotope({ filter: e }), !1;
        }),
        ...
        o(".smooth-scroll").smoothScroll({ speed: 1e3, easing: "swing" }),
        ...
        o("select").niceSelect(),
        o(".event-thumbnail-carousel").owlCarousel({
            items: 1,
            loop: !0,
            dots: !1,
            nav: !0,
        ...
        o(".scroll-top").on("click", function () {
            return o("html").animate({ scrollTop: 0 }, 2e3), !1;
        }),
    ...
    o("form#cbx-contact-form").validate({
        submitHandler: function (e) {
            ...
            return (
                o.ajax({
                    ...
                    success: function (s) {
                        try {
                            (s = o.parseJSON(s)).validation_error
                                ? o.each(s.error_field, function (e) {
                                      0 ==
                                          o(
                                              "label#" +
                                                  s.error_field[e] +
        ...
        o("form#cbx-subscribe-form").validate({
            ...
            errorPlacement: function (e, s) {
                console.log("dd", s.attr("name")),
                    "email" == s.attr("name")
                        ? o("#cbx-subscribe-form-error").html(e)
                        : e.insertAfter(s);
            },
        ...
        o(document).ready(function () {
            o(".dropdown-menu a.dropdown-toggle").on("click", function (e) {
                ...
                return (
                    ...
                    o(this).parent("li").toggleClass("show"),
                    o(this)
